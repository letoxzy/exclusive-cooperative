...
================================ */
  ...
  const handleMarkEntryPaid = async (distributionId, entryId) => {
    try {
      ...
      await request(
        `/admin/dividends/${distributionId}/entries/${entryId}`,
        {
          method: "PATCH",
          token: user.token,
        }
          ...
          <div className="admin-page-heading">
            <div>
              ...
              <p className="admin-subtitle">
                ...
                eligible. Shares are split proportional to each member's
    ...
    return (
      <>
        <div className="admin-page-heading">
          <div>
            ...
            <p className="admin-subtitle">
              ...
              (interest-bearing) members based on their savings
              contribution.
            </p>
          </div>
        ...
        {showCreateDividendForm && (
          <section className="admin-card">
            <form className="dividend-create-form" onSubmit={handleCreateDividend}>
      ...
      <>
        <div className="admin-page-heading">
          <div>
            ...
            <p className="admin-subtitle">
              Review a member's BVN and bio-data before they're allowed to
              apply for an actual loan. Approving here sets them as loan
              eligible.
            </p>
          </div>
        </div>
